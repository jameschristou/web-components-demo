...
template.innerHTML = `
<div class="superTextfieldContainer">
  <input type="text" class="superTextfield"/>
  <div class="superTextfieldActionsContainer hidden">
    <div class="superTextfieldActions">
      <button class="superTextfieldAction__save" tabindex="0">
      ...
      <button class="superTextfieldAction__cancel" tabindex="1">
        <svg width="24" height="24" viewBox="1 -2 24 24" focusable="false" role="presentation">
...
class SuperTextfield extends HTMLElement {
  constructor(){
    super();
    ...
    this._textinput = this._clonedNode.querySelector('.superTextfield');
    this._actionsdiv = this._clonedNode.querySelector('.superTextfieldActionsContainer');
    ...
    this._clonedNode.querySelector('.superTextfieldAction__save').onclick = e => {
      this.saveCurrentEdit();
    };

    this._clonedNode.querySelector('.superTextfieldAction__cancel').onclick = e => {
  ...
  set disabled(val) {
    if (val == '') {
      ...
      this._textinput.setAttribute('disabled', '');
    } else {
      this.removeAttribute('disabled');
      this._textinput.removeAttribute('disabled');
    }
  }
...
customElements.define('super-textfield', SuperTextfield);
